...
<%
    ...
    int Rinstructor = Integer.parseInt(request.getParameter("Rins")); // Recuperar el parámetro enviado desde el primer JSP
    ...
    File reportFile = new File(application.getRealPath("Reports/Instructores.jasper"));
